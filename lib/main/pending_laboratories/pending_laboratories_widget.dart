...
import 'pending_laboratories_model.dart';
export 'pending_laboratories_model.dart';

class PendingLaboratoriesWidget extends StatefulWidget {
  const PendingLaboratoriesWidget({super.key});

  @override
  State<PendingLaboratoriesWidget> createState() =>
      _PendingLaboratoriesWidgetState();
}

class _PendingLaboratoriesWidgetState extends State<PendingLaboratoriesWidget> {
  late PendingLaboratoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PendingLaboratoriesModel());
  }
                                                                ...
                                                                Row(
                                                                  mainAxisSize:
                                                                      MainAxisSize
                                                                          .max,
                                                                  children: [
                                                                    if (pendingLaboratoriesRequestRecord
                                                                            .status ==
                                                                        'pending')
                                                                      Container(
                                                                        width:
