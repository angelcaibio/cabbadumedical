...
class _ReviewWidgetState extends State<ReviewWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ConsultationRecord>(
      stream: ConsultationRecord.getDocument(widget!.consultation!),
      builder: (context, snapshot) {
        ...
        final reviewConsultationRecord = snapshot.data!;
              ...
              children: [
                StreamBuilder<ScheduleRecord>(
                  stream: ScheduleRecord.getDocument(
                      reviewConsultationRecord.schedule!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                        ...
                        children: [
                          StreamBuilder<PatientsRecord>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final namePatientsRecord = snapshot.data!;
                                                        ...
                                                        child: Text(
                                                          valueOrDefault<
                                                            ...
                                                            dateTimeFormat(
                                                                ...
                                                                reviewConsultationRecord
                                                                    .followup),
                                                            'No follow up consultation is required',
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                                                              ...
                                                                                              Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  Padding(
                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 2.0),
                                                                                                    child: Text(
                                                                                                      'Dosage: ${resultsMedicationRecord.dosage}',
                                                                                                      style: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                                            fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
                                                                                                            letterSpacing: 0.0,
                                                                                                            useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelSmallFamily),
                                                                                              ...
                                                                                              Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  Padding(
                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 2.0),
                                                                                                    child: Text(
                                                                                                      'Frequency: ${resultsMedicationRecord.frequency}',
                                                                                                      style: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                                            fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
                                                                                                            letterSpacing: 0.0,
                                                                                                            useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelSmallFamily),
                                                                                              ...
                                                                                              Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  Padding(
                                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 2.0),
                                                                                                    child: Text(
                                                                                                      'Duration: ${resultsMedicationRecord.duration} days',
                                                                                                      style: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                                            fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
                                                                                                            letterSpacing: 0.0,
                                                                                                            useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelSmallFamily),
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await columnScheduleRecord.reference
