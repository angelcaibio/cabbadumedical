...
class _OverviewWidgetState extends State<OverviewWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ScheduleRecord>(
      stream: ScheduleRecord.getDocument(widget!.consultation!),
      builder: (context, snapshot) {
        ...
        final overviewScheduleRecord = snapshot.data!;
              ...
              children: [
                StreamBuilder<PatientsRecord>(
                  stream: PatientsRecord.getDocument(
                      overviewScheduleRecord.patient!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(
                                                        child: Text(
                                                          '${overviewScheduleRecord.weight.toString()} KG',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(
                                                        child: Text(
                                                          '${overviewScheduleRecord.temperature.toString()}°C',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(
                                                        child: Text(
                                                          '${overviewScheduleRecord.bloodPressure.toString()} mmHg',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Expanded(
                                                                                    child: StreamBuilder<LaboratoriesRecord>(
                                                                                      stream: LaboratoriesRecord.getDocument(resultsRequestRecord.laboratory!),
                                                                                      builder: (context, snapshot) {
                                                                                        // Customize what your widget looks like when it's loading.
                                                                                        if (!snapshot.hasData) {
                                                                                          return Center(
                                                                                        ...
                                                                                        final columnLaboratoriesRecord = snapshot.data!;
